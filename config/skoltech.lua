...
-- Constraint search --
POSE_GRAPH.max_local_constraint_distance = 40.
POSE_GRAPH.local_constraints_per_node = 0.01
...
-- POSE_GRAPH.local_constraints_per_node = 0.02
...
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher_3d.linear_z_search_window = 5.0  -- 1.0
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher_3d.angular_search_window = math.rad(20.0)  -- math.rad(15.0)
