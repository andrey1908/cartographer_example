...
-- Motion filter --
TRAJECTORY_BUILDER_3D.motion_filter.max_time_seconds = 0.001
TRAJECTORY_BUILDER_3D.motion_filter.max_distance_meters = 0.001
TRAJECTORY_BUILDER_3D.motion_filter.max_angle_radians = 0.001
